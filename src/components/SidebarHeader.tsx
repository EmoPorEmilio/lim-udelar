      ...
      <div style={{
        ...
        >
          <Show when={theme() === 'dark'}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" style={{ stroke: 'var(--color-blue-300)' }} stroke-width="2.5">
          ...
          <Show when={theme() !== 'dark'}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" style={{ stroke: 'var(--color-accent)' }} stroke-width="2.5">
